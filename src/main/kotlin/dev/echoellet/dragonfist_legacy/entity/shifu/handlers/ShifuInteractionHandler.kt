...
import dev.echoellet.dragonfist_legacy.mod_integration.EpicSkillsTreeModHelper
...
class ShifuInteractionHandler(private val entity: ShifuEntity) {
    ...
    fun handle(player: Player, hand: InteractionHand): InteractionResult {
        ...
        if (!EpicSkillsTreeModHelper.isInstalled()) {
    ...
    private fun handleSuccessfulTrade(
        ...
        EpicSkillsTreeModHelper.addAbilityPoint(player, pointsToAdd = result.abilityPointsGained)
